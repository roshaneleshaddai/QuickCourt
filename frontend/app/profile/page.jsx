    ...
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6 sm:mb-8">
          <div className="h-24 sm:h-32 bg-gradient-to-r from-green-400 to-green-600"></div>
          <div className="px-4 sm:px-6 pb-4 sm:pb-6">
            <div className="flex flex-col sm:flex-row sm:items-end -mt-12 sm:-mt-16 mb-4">
              <div className="relative mx-auto sm:mx-0 mb-4 sm:mb-0">
                <div className="w-24 h-24 sm:w-32 sm:h-32 bg-white rounded-full border-4 border-white flex items-center justify-center">
                  {user?.profilePicture ? (
                    <img
              ...
              <div className="mt-4 sm:mt-0">
                {!editing ? (
                  <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors text-sm sm:text-base"
                  >
                  ...
                  <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors text-sm sm:text-base"
                    >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              ...
              <div className="text-center">
                <p className="text-sm font-bold text-purple-600">
                  {user?.stats?.mostPlayedSport || "Not set"}
                </p>
                <p className="text-sm text-gray-600">Favorite Sport</p>
              </div>
              <div className="text-center">
                <p className="text-sm font-bold text-orange-600">
                  {user?.stats?.favoriteTime || "Not set"}
                </p>
            ...
            <nav className="flex overflow-x-auto px-4 sm:px-6 scrollbar-hide">
              {[
                ...
                <button
                  ...
                  className={`flex-shrink-0 py-3 sm:py-4 px-3 sm:px-4 border-b-2 font-medium text-xs sm:text-sm flex items-center whitespace-nowrap ${
                    activeTab === tab.id
                    ...
                    {sports.map((sport) => (
                      <button
                        ...
                        className={`p-3 sm:p-4 border-2 rounded-lg text-left transition-colors ${
                          formData.preferences?.favoriteSports?.includes(
                            sport.id
                          )
